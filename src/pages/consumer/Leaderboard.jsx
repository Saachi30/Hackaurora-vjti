...
export const Leaderboard = () => {
  const leaderboardData = [
    { rank: 1, name: "Suhani Shah", score: 95, change: "up", type: "Vendor" },
    { rank: 2, name: "Green Consumer Co", score: 92, change: "down", type: "Consumer" },
    { rank: 3, name: "Kriti Sanon", score: 88, change: "up", type: "Vendor" },
    { rank: 4, name: "Monjulika Kaur", score: 85, change: "up", type: "Vendor" },
